...
Set fr4128 = This.Workbook.Sheets("4128FR")
Set data = ThisWorkbook.Sheets("Data")

cc4128LR = cc4128.ListObjects("CC4128A").TotalsRowRange.Row - 1
fr4128LR = fr4128.ListObjects("FR4128A").TotalsRowRange.Row - 1
